...
# 2024/12/15
- [DONE] 解决升级[过河拆桥]时游戏闪退的问题。
- [DONE] 解决升级[顺手牵羊]时不显示更新效果的问题。
- [DONE] 解决败者在没有[白兽雕像]的情况下仍然获得3瓶药水的问题。
- [DONE] 移除了Config界面里面额外的[卡池]选项。
- [DONE] 解决连续开两局游戏时，第二局禁卡效果不生效的问题。

# 2024/12/29
- [DONE] 解决黑球激发数值不同步的问题。
- [DOING] 实现pvp里面的配置选项保存功能。