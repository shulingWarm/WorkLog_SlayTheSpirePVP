...
- [DONE] 添加一个子页面用于给卡牌添加各种能量。
	- 工作状态:
		...
		- [DONE] 由于加减能量的控件显示不协调，需要调整输入文本框的大小。
		- [DONE] 调整输入文本框的相对位置。
		- [DONE] 子任务3 添加一个独立的页面，用于把能量Item在里面列举显示。
- [DONE] 用目前的PowerMapping在添加能量的页面中列出所有的能量。
- [TO-DO] 实现某个卡牌保存时，保存相应的能量信息。
- [TO-DO] 实现修改卡牌名字的UI。